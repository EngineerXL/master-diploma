...
\textbf{2. Срок сдачи обучающимся законченной работы} \uline{18.06.\the\year \hfill}
...
\begin{table}
    ...
    6 & Оформление выпускной квалификационной работы и презентационных материалов & 5\% & 18.05.\the\year--18.06.\the\year & \\ \hline
    \end{tabularx}
\end{table}
